...
function getTransportModes(arr) {
  let elementOfArr = arr.slice(1, arr.length);
  return elementOfArr;
}
...
*/
function isAccessibleByTransportMode(howToGetThere, choice) {
  
  if(choice.includes(howToGetThere)) {
    return true;
  }
  else {
    return false;
